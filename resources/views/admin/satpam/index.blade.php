...
<x-app-layout>
    ...
    @section('header_action')
        <div class="flex items-center space-x-3">
            <a href="{{ route('satpam.rekap') }}" class="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-full text-[12px] font-bold transition-all shadow-sm flex items-center space-x-1.5">
